...
<body>
  ...
  <div class="overlay"></div>
    <section class="section full-height is-flex is-justify-content-center is-align-items-center">
        <div class="container">
            <h1 class="title has-text-centered has-text-weight-bold">Iniciar Sesión</h1>
